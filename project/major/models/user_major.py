...
class UserMajor(Base):
    ...
    major_id: Mapped[int] = mapped_column(Integer, ForeignKey('majors.id'), nullable=True)
    temp_major_id: Mapped[int] = mapped_column(Integer, ForeignKey('temp_majors.id'), nullable=True)
